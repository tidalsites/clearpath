...
export const About = () => {
  return (
    <section
      id="about"
      className="bg-theme overflow-hidden flex flex-col md:flex-row-reverse relative min-h-[600px] isolate"
    >
      <div className="flex flex-col gap-2 px-8 py-12 bg-background lg:mr-8 lg:w-fit">
        <h2 className="text-4xl uppercase font-barlow border-b-2 py-2 w-fit text-theme">
          About us
        </h2>
      ...
      <div className="flex flex-col items-center xl:flex-row gap-y-20 gap-x-12 px-12 py-2 rounded-3xl h-fit my-12 w-full lg:justify-end">
        <div className="rounded-3xl p-4 bg-background text-foreground flex flex-col gap-2 relative max-w-[35ch] lg:max-w-none">
          <div className="flex gap-4 abolute top-0 left-0">
            <Image
              className="rounded-full -outline-offset-6 outline-2 border-4 border-theme outline-neutral-100 bg-background -translate-1/4"
              src={headshot1}
              alt=""
              width={150}
              height={150}
          ...
          <div className="flex flex-col p-4 border-t-2 border-theme -mt-4">
        ...
        <div className="rounded-3xl p-4 bg-background text-foreground flex flex-col gap-2 relative max-w-[35ch] lg:max-w-none">
          <div className="flex flex-row-reverse gap-4 abolute top-0 left-0 lg:flex-row">
            <Image
              className="rounded-full -outline-offset-6 outline-2 border-4 border-theme outline-neutral-100 bg-background translate-x-1/4 -translate-y-1/4 lg:-translate-1/4"
              src={headshot2}
              alt=""
              width={150}
              height={150}
